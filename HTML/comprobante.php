...
$detalle_sql = "
SELECT p.nombre, d.cantidad, d.subtotal, (d.subtotal / d.cantidad) AS precio_unitario
      ...
      <tbody>
        <?php while ($fila = $detalles->fetch_assoc()): ?>
          <tr>
            ...
            <td class="text-end">S/ <?= number_format($fila['precio_unitario'], 2) ?></td>
            <td class="text-end">S/ <?= number_format($fila['subtotal'], 2) ?></td>
          </tr>
        <?php endwhile; ?>
      </tbody>
    </table>
